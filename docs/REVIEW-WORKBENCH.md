...
[AutoMontage-Agent v1.3.0](https://github.com/Ntmib/AutoMontage-Agent/releases/tag/v1.3.0).
...
В Review нет кнопки утверждения. Закрой локальный сервер и выполни отдельную команду, указав
тот `vNN-draft.lesson.json`, который только что создал Save:
...
ripple, не удаляет импортированные файлы, не утверждает draft и сам не запускает render.
