...
`409` браузер загружает свежий disk state, очищает активные undo/redo-команды и блокирует
timeline, b-roll и Save. Устаревшие правки не применяются: продолжить с новой версии можно
только явной кнопкой «Отбросить устаревшие правки и продолжить», после чего новая команда
