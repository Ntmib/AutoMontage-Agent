...
//  2) КАЖДАЯ врезка — своя картинка (10 уникальных, без повторов).
...
export const scenarioPreviewH = {
  ...
  blocks: [
    ...
    { type: 'BrollFullscreen', start: 15.5, end: 19.0, image: 'broll/realA.png', caption: 'готовый ролик за минуты', fit: 'cover', transition: 'slide' },
    // врезка 2 — таймлайн
    { type: 'BrollFullscreen', start: 21.5, end: 23.0, image: 'broll/realC.png', caption: 'таймлайн', fit: 'contain', transition: 'wipe' },

    { type: 'SubtitleCard', start: 25.2, end: 28.0, text: 'Субтитры слово в слово', accent: true, pos: { h: 'left', v: 'top' } },

    // врезка 3 — руки монтажёра
    { type: 'BrollFullscreen', start: 30.5, end: 32.0, image: 'broll/edit_hands.png', caption: 'монтаж', fit: 'cover', transition: 'slide' },
    ...
    { type: 'BrollFullscreen', start: 48.8, end: 50.3, image: 'broll/agent_edit.png', caption: 'редактор', fit: 'contain', transition: 'wipe' },

    // врезка 6 — генерация картинки ИИ
    { type: 'BrollFullscreen', start: 51.0, end: 55.5, image: 'broll/ai_chip.png', caption: 'сгенерирует картинку под смысл', fit: 'cover', transition: 'slide' },

    { type: 'SubtitleCard', start: 62.0, end: 65.0, text: 'Реалистичное фото', accent: true, sub: 'на весь экран', pos: { h: 'right', v: 'top' } },
    // врезка 7 — настоящая фотография
    { type: 'BrollFullscreen', start: 65.5, end: 69.5, image: 'broll/realB.png', caption: 'настоящая фотография', fit: 'cover', transition: 'wipe' },
    ...
    // врезка 9 — аудио-пульт
    { type: 'BrollFullscreen', start: 89.0, end: 90.5, image: 'broll/audio_desk.png', caption: 'звук', fit: 'cover', transition: 'wipe' },
